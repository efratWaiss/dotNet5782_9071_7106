...
namespace DO
{
    public class DataSource
    {
        ...
        internal static void Initialize()
        {
            ...
            parcels.Add(new Parcel(325036552, 325036559, WeightCategories.Intermediate, Priorities.Emergency, new DateTime(2021, 05, 5, 9, 23, 12), 4, new DateTime(2022, 5, 8, 9, 23, 12), null, null));
